  ...
  <div id="site-navigation" class="navbar navbar-fixed-top" role="navigation">
    <div class="navbar-inner">
      <div class="container">
		...
		<div class="follow_us">Ακολουθήστε μας &nbsp; &nbsp; 
  ...
  <div id="page" class="hfeed site container">
  	<header id="masthead" class="site-header hero-unit" role="banner">
		...
		<form method="get" id="searchform" class="navbar-search pull-right" action="<?php bloginfo('home'); ?>/">
  			<div>
  					<input type="text" name="s" id="s" class="search-query" placeholder="<?php echo __( 'Search', 'boilerstrap' ); ?>" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" tabindex="1">
  			</div>
  			</form>
		 <h1><?php echo  get_bloginfo( 'name' ) ; ?><br /><span><?php echo  get_bloginfo( 'description' ) ; ?></span></h1>
